        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="halaman_user.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#about">Data Siswa</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            <div class="col-md-6 my-2" id="about">
                ...
                <p> websie siswa ini di buat guna memenuhi tugas UAS mata kuliah pemrograman web 2 di susun oleh siti nurjanah(701220019) </p>
            </div>
            <div class="col-md-6 my-2 text-center link">
                <h4 class="fw-bold text-uppercase">Account Links</h4>
                <a href="https://web.facebook.com" target="_blank"><i class="bi bi-facebook fs-3"></i></a>
